...
public class PFD extends JPanel implements MouseMotionListener, MouseListener   {
	...
	public void updateMousePosition(MouseEvent e, ArrayList<Float> array) {
		array.set(0, (float) (e.getX() + 2));
		array.set(1, (float) (e.getX() - 2));
	...
	public void mouseMoved(MouseEvent e) {
		jLabel5.setText("PFD");
		jLabel6.setBounds(jLabel6.getBounds().x,
				e.getY()-1000, 1600, 1600);
		rad = e.getX();
		jPanel2.setRad(e.getX());
		jPanel1.repaint();
		jPanel2.repaint();
